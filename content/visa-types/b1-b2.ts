...
export const b1b2: VisaTypeContent = {
  slug: "b1-b2",
  code: "B1/B2",
  ...
  whoItsFor: [
    ...
    "Applicants visiting U.S. relatives or friends",
    "Applicants who have been refused before and are reapplying",
  ],
  informationUsed: [
    "Purpose and length of your trip",
    "Your itinerary and who you're visiting, if applicable",
    "Who is funding the trip and how",
    "Your employment or business ties at home",
    "Family ties and prior international travel history",
    "Any U.S. relatives or previous U.S. visas",
  ],
  topics: [
    {
      title: "Purpose of your trip",
      description:
        "Why you're traveling, where you're going, and how long you plan to stay.",
    },
    {
      title: "Finances",
      description:
        "Whether you or your host can afford the trip, and who is paying for it.",
    },
    {
      title: "Ties to home",
      description:
        "Your job, business, family, or property that connect you to your home country and your plans to return.",
    },
    {
      title: "Travel history",
      description:
        "Previous trips abroad, including any prior U.S. visas or visits.",
    },
    {
      title: "Business details (if applicable)",
      description:
        "Your role, your company, and the purpose of the specific meetings or events for business travel.",
    },
  ],
  faqs: [
    {
