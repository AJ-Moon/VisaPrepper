...
export const j1: VisaTypeContent = {
  slug: "j1",
  code: "J1",
  ...
  whoItsFor: [
    ...
    "Au pairs and work-and-travel participants",
    "Applicants sponsored by a specific J1 program who want to prepare for their interview",
  ],
  informationUsed: [
    "Your program sponsor and category (DS-2019)",
    "Your program details, duration, and host organization",
    "How your program is funded",
    "Your ties to your home country",
    "Your understanding of program requirements, including the two-year home residency requirement if it applies to you",
  ],
  topics: [
    {
      title: "Program purpose and sponsor",
      description:
        "What your program involves, who is sponsoring it, and why you were selected.",
    },
    {
      title: "Funding",
      description:
        "How your participation is funded, including any stipend, personal funds, or sponsor support.",
    },
    {
      title: "Plans during and after",
      description:
        "What you'll be doing during the program and your plans once it ends.",
    },
    {
      title: "Home country ties",
      description:
        "Your connections to your home country and your intentions to return after the exchange program.",
    },
  ],
  faqs: [
    {
