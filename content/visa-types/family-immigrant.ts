...
export const familyImmigrant: VisaTypeContent = {
  ...
  whoItsFor: [
    ...
    "Applicants preparing for a joint-life or relationship-focused interview",
    "Applicants who want to practice explaining their relationship history clearly and consistently",
  ],
  informationUsed: [
    "Your relationship to the petitioner and how you met",
    "Your relationship or marriage timeline and key milestones",
    "Shared life details, if applying as a spouse (living arrangements, shared responsibilities)",
    "Family background and any prior marriages, if relevant",
    "Financial sponsor details (Form I-864), if you're familiar with them",
  ],
  topics: [
    {
      title: "Relationship history",
      description:
        "How you met your petitioner, how the relationship developed, and key dates and milestones.",
    },
    {
      title: "Shared life details",
      description:
        "For spouse-based cases, everyday details about living together and shared responsibilities.",
    },
    {
      title: "Family background",
      description:
        "Basic family history, and any prior marriages or relationships where relevant.",
    },
    {
      title: "Petition consistency",
      description:
        "Making sure your answers match the relationship history and details described in your petition.",
    },
  ],
  faqs: [
    {
