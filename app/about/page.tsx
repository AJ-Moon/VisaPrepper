...
export const metadata: Metadata = buildPageMetadata({
  title: "About VisaPrepper",
  description: "VisaPrepper helps applicants prepare clear, honest answers for their visa interview. Available in Pakistan in English and Urdu, with more countries coming soon.",
  path: "/about",
});
  ...
  return <>
    ...
    <Container className="py-12 sm:py-16">
      ...
      <div className="mt-8 max-w-2xl space-y-5 text-base leading-relaxed text-muted-foreground">
        <p>VisaPrepper gives you a place to practice talking about it. Answer questions about your own application, find out what is unclear, and work on it before you sit down for your interview.</p>
        ...
        <p>Our job is to help you explain your real circumstances clearly. We do not promise visa approval or ask you to memorize made-up answers. VisaPrepper is independent of every embassy and government agency.</p>
      </div>
    </Container>
