...
export const metadata = {...buildPageMetadata({title,description:"Practise a complete AI video visa interview based on your own forms and personal details. Get document checks, personalised tips, results and confidence scores.",path:"/"}),title:{absolute:title}};
const problems = [
 ...
 return <>
  ...
  <section className="bg-gradient-to-b from-sage-soft/70 to-background">
   <Container className="grid items-center gap-12 py-14 sm:py-20 lg:grid-cols-[1.1fr_0.9fr]">
    <div><p className="text-sm font-semibold text-primary">Complete AI video visa interview practice</p>
     ...
     <p className="mt-5 text-sm">One payment. Six complete AI video interviews. A report after every interview.</p>
  ...
  <section className="bg-surface-muted"><Container className="py-16">
   ...
   <ol className="mt-8 grid gap-6 md:grid-cols-3">{[
    ...
    ["See your scores and next steps","Find answer problems, confidence problems and inconsistencies. Use your personalised tips before practising again."],
  ...
  <section id="languages"><Container className="py-14"><SectionHeading eyebrow="Closer to home" title="Practise in words you understand." description="English, Urdu and Hindi are available now. Bengali is coming soon."/><div className="mt-8"><LanguageWelcome/></div></Container></section>
  <MobileApps/>
