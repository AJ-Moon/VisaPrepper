...
export const alt = "Visa Prepper — Complete AI video visa interview practice";
...
export default function Image() {
  return new ImageResponse(<div style={{width:"100%",height:"100%",background:"#184b3c",color:"#fbf7f1",display:"flex",flexDirection:"column",justifyContent:"center",padding:80}}>
    ...
    <div style={{fontSize:68,fontWeight:700,lineHeight:1.12,maxWidth:990}}>Face the AI interviewer before the real interview.</div>
    <div style={{fontSize:28,marginTop:35}}>Full video interviews. Document checks. Personal results.</div>
