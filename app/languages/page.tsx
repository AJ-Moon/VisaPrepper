...
export default function LanguagesPage() {
  return <>
    ...
    <Container className="py-12 sm:py-16">
      <SectionHeading titleAs="h1" eyebrow="Your language" title="Feel comfortable finding your words." description="Practice your visa interview in English, Urdu or Hindi. We currently support applicants in Pakistan and India, with Bengali and Bangladesh support coming soon." />
