...
export const metadata: Metadata = buildPageMetadata({
  title: "How to Prepare with Visa Prepper",
  ...
  return <>
    ...
    <Container className="py-12 sm:py-16">
      ...
      <div className="mx-auto mt-12 max-w-2xl"><FAQAccordion items={[
        { question: "How many interviews can I take?", answer: "The $44 package includes six complete AI practice interviews total, not six of each mode. You also get ten document checks and 90 days from purchase to use the package." },
