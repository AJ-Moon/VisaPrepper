...
export default async function StartPage({searchParams}:{searchParams:Promise<{intent?:string}>}) {
  ...
  return <Container className="max-w-3xl py-16">
    ...
    <p className="mt-5 text-lg">{free ? "Your free access includes one document check and preparation guides. It does not include a live AI interview." : "$44 USD once. Six AI practice interviews, ten document checks, and a report after every interview. Use the package within 90 days of purchase."}</p>
