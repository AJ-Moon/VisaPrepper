    ...
    <section id="mobile-apps" className="scroll-mt-24 overflow-hidden bg-sage-soft/60">
      <Container className="grid items-center gap-10 py-14 sm:py-16 md:grid-cols-[1.1fr_0.9fr]">
        <ScrollReveal>
          ...
          <p className="mt-5 max-w-md text-base leading-relaxed text-muted-foreground">Practice on Android or iPhone wherever you feel ready. The web app is available now; the Google Play and Apple App Store apps are on the way.</p>
